...
var degrees = ['高中', '中专', '小学', '初中', '大专', '本科', '硕士', '博士'];
var ddlCity;
var ddlProvince;
function _initProviceAndCity(id1, id2) {
    ddlProvince = document.getElementById(id1);
    ddlCity = document.getElementById(id2);
