        ...
        <div class="col-md-10">
            ...
            <form method="post" action="" id="formId" class="form-inline">
                <div clss="well">
                    ...
                    <@shiro.hasPermission name="/permission/export.shtml">
                        <a id="btn2" class="btn btn-success" href="${basePath}/permission/export.shtml">导出权限信息</a>
                    </@shiro.hasPermission>
				         </span>
                </div>
                <hr>
                ...
                <#if page?exists && page.list?size gt 0 >
                    <#list page.list as it>
                        <tr>
                            <td><input value="${it.pid}" check='box' type="checkbox"/></td>
                            <td>${it.name?default('-')}</td>
                            <td>${it.url?default('-')}</td>
                            <td>
                                <i class="glyphicon glyphicon-remove"></i><a href="javascript:deleteById([${it.pid}]);">删除</a>
                            </td>
                        </tr>
                    </#list>
                <#else>
