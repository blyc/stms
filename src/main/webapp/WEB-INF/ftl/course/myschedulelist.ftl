...
<head>
    ...
    <script>
        $(function () {
            var ccid = ${cid};
            $.ajax({
                url:'${basePath}/attendance/schedulelistall.shtml',
                type:'post',
                data:'id='+ccid,
        ...
        function _openAddDlg(cid) {
            $.post('/attendance/getClasstname.shtml', {cid: cid}
                    , function (result) {
        ...
        <@shiro.hasPermission name="/attendance/addschedule.shtml">
        function _addSChedule(cid) {
            ...
            var place = $("#place").val()
            $.ajax({
                url:'${basePath}/attendance/addschedule.shtml',
                type: 'post',
