...
<head>
    ...
    <script>
        function exportfunc() {
            var url = "${basePath}/summary/exportTeacher.shtml?findContent=" + $("#findContent").val() + "&queryDate=" + $("#dtp_input2").val();
                ...
                <div clss="well">
                    <div class="form-group">
                        <input type="text" class="form-control" style="width: 300px;" value="${findContent?default('')}"
                               name="findContent" id="findContent" placeholder="输入校区/讲师/班主任" maxlength="10">
                    </div>
                    <div class="form-group">
