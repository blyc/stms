...
var yred=0.35*canvasElement.width*0.22;
var redYlimt=0.45*canvasElement.width*0.22;
 function draw(){
     ...
     //画圆 color r x y
     drawCircle("#f7f4d3",canvasElement.width*0.06,0.44*canvasElement.width,redYlimt,"#fcf6ac");                         //红
     drawCircle("#201620",canvasElement.width*0.0125,0.95*canvasElement.width,0.32*canvasElement.height);       //灰
     drawCircle("#140c2a",canvasElement.width*0.005,0.75*canvasElement.width,0.22*canvasElement.height);        //紫
     drawCircle("#090929",canvasElement.width*0.009,0.82*canvasElement.width,0.52*canvasElement.height);       //蓝
     if(redstart==true){
         redYlimt+=1;
     }
     if(redYlimt>yred){
