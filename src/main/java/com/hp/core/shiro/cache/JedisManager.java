package com.hp.core.shiro.cache;

import com.hp.common.utils.LoggerUtils;
import com.hp.common.utils.SerializeUtil;
    ...
    public Jedis getJedis() {
        ...
        try {
        	...
        	if("Could not get a resource from the pool".equalsIgnoreCase(message)){
        		...
        		System.out.println("|①.请检查是否安装redis服务，如果没安装，Windos 请参考Blog：http://www.hp.com/blog/110.html|");
        		...
        		System.out.println("|④.QQ群：259217951，目前需要付费，免费的方案请参考链接：http://www.hp.com/shiro");
        		
        		System.out.println("|PS.如果对Redis表示排斥，请使用Ehcache版本：http://www.hp.com/jc_shiro_ssm_ehcache.html");
