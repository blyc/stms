...
public class ExporeStudentProjectUtil {
     ...
     * @param dataList    数据
     */
    public void wirteExcel(String fileName, HttpServletResponse response, UTaskResults ecpr, List<UTaskAccomplishResults> dataList) {

        String titleColumn[] = {"name", "taskgrade"};
        ...
        try {
            ...
            double d1 = dataList.size();
            double d2=0;
            for (UTaskAccomplishResults u:dataList){
                if(u.getTaskgrade().equals(1l)){
                    d2++;
                }
            }
            double d= d2/d1;
