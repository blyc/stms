...
public class PoiExcelExport {
    ...
    public PoiExcelExport(String sheetName) {
        this.fileDir = fileDir;
        this.sheetName = sheetName;
        workbook = new XSSFWorkbook();
    }
     ...
     * @param dataList    数据
     */
    public void wirteExcel(String fileName, HttpServletResponse response, String titleColumn[], String titleName[], int titleSize[], List<?> dataList) {
        ...
        try {
         ...
         /*  fileName = fileName + ".xlsx";
            ...
            //写入excel的表头
            XSSFRow titleNameRow = workbook.getSheet(sheetName).createRow(0);
            //设置样式
            XSSFCellStyle titleStyle = workbook.createCellStyle();
            titleStyle = (XSSFCellStyle) setFontAndBorder(titleStyle, "宋体", (short) 10, false, String.valueOf((short) IndexedColors.WHITE.getIndex()), FillPatternType.SOLID_FOREGROUND);
                    ...
                    for (int rowIndex = 1; rowIndex <= dataList.size(); rowIndex++) {
                        ...
                        for (int columnIndex = 0; columnIndex < titleColumn.length; columnIndex++) {
                            ...
                            if (!"".equals(title)) {  //字段不为空
                                ...
                                // 设置要执行的方法/*getDeclaredMethod不可以调用继承类的方法*/
